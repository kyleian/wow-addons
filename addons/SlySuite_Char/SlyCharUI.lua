...
function SC_BuildMain()
    ...
    do
        ...
        honorContent:HookScript("OnShow", function()
    ...
    -- helper: show/hide the correct page of buttons and update the toggle btn
    ...
    for i, bd in ipairs(STRIP_BTNS) do
        -- which visual slot this button occupies within its page
        local slot = ((i - 1) % PAGE_SIZE)
    ...
    do
        local pBtnH = 12
        -- top edge = 4px + PAGE_SIZE slots = 4 + PAGE_SIZE*(bSz+3) from TOP
        ...
        pgTx:SetFont(pgTx:GetFont(), 9, "OUTLINE")
    ...
    ftxt:SetText("C or /slychar  |  left-click = gear picker  |  shift+click = socket  |  right-click = link  |  strip p1: T·Sp·Q·M·B  ▾  p2: SR·Wh·Mc·Fr·NIT")
