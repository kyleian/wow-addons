...
-- ============================================================
-- DRUID  (TBC 2.x — all spells verified TBC-valid)
-- ============================================================
SLYCHAR_CLASS_MACROS["DRUID"] = {
    ...
    -- ── Balance ───────────────────────────────────────────────────────────────
    {
        ...
        tip="Primary Moonkin nuke. High damage, long cast. Procs Nature's Grace.",
    },
    {
        spec="Balance", name="Wrath",
        icon="spell_nature_abolishmagic",
        body="#showtooltip Wrath\n/cast Wrath",
        tip="Fast nature nuke. Use with Nature's Grace proc window or on the move.",
    },
    {
        spec="Balance", name="Moonfire",
        icon="spell_nature_starfall",
        body="#showtooltip Moonfire\n/cast Moonfire",
        tip="Instant DoT + instant direct damage. Apply at pull and keep rolling.",
    },
    {
        spec="Balance", name="Insect Swarm",
        icon="spell_nature_insectswarm",
        body="#showtooltip Insect Swarm\n/cast Insect Swarm",
        tip="DoT + -2% hit debuff on target. Talent required. Keep active.",
    },
    {
        spec="Balance", name="Hurricane",
        icon="spell_nature_cyclone",
        body="#showtooltip Hurricane\n/cast Hurricane",
        tip="Channeled AoE nature damage. Use for pack clearing / AoE phases.",
    },
    {
        spec="Balance", name="Faerie Fire",
        icon="spell_nature_faeriefire",
        body="#showtooltip Faerie Fire\n/cast Faerie Fire",
        tip="-5 armor reduction stacks (570 armor). Keep up for physical group.",
    },
    {
        spec="Balance", name="NS + Healing Touch",
        icon="spell_nature_ravenform",
        body="#showtooltip Healing Touch\n/cast Nature's Swiftness\n/cast Healing Touch",
        tip="Instant full Healing Touch. Emergency self/ally save cooldown.",
    },
    {
        spec="Balance", name="Innervate",
        icon="spell_nature_lightning",
        body="#showtooltip Innervate\n/cast [@mouseover,help,nodead][@player] Innervate",
        tip="Restore mana to mouseover healer or yourself. 6-min CD.",
    },

    -- ── Feral DPS (Cat) ───────────────────────────────────────────────────────
    {
        spec="Feral", name="Powershift",
        icon="ability_druid_catform",
        body="/cancelaura Cat Form\n/cast Cat Form",
        tip="THE signature TBC feral DPS macro. Cancel + re-enter Cat Form to reset energy via Furor talent. Use on energy cap.",
    },
    {
        spec="Feral", name="Cat Form",
        icon="ability_druid_catform",
        body="#showtooltip Cat Form\n/cast [noform:3] Cat Form\n/cast [form:3,nostealth] Prowl",
        tip="Enter Cat Form. Shift-press or use when already in cat to toggle Prowl.",
    },
    {
        spec="Feral", name="Mangle (Cat)",
        icon="ability_druid_mangle2",
        body="#showtooltip Mangle (Cat)\n/cast [stance:3] Mangle (Cat)",
        tip="Core Cat combo builder. Applies Mangle debuff: +30% bleed damage on target.",
    },
    {
        spec="Feral", name="Shred",
        icon="spell_shadow_vampiricaura",
        body="#showtooltip Shred\n/cast [stance:3] Shred",
        tip="Highest damage Cat combo builder. Must be BEHIND target. Use over Mangle when positional possible.",
    },
    {
        spec="Feral", name="Rake",
        icon="ability_druid_disembowel",
        body="#showtooltip Rake\n/cast [stance:3] Rake",
        tip="Bleed+instant damage opener. Apply on every target, keep ticking.",
    },
    {
        spec="Feral", name="Rip",
        icon="ability_ghoulfrenzy",
        body="#showtooltip Rip\n/cast [stance:3] Rip",
        tip="Primary bleed finisher. Use at 5 CPs for maximum sustained DPS.",
    },
    {
        spec="Feral", name="Ferocious Bite",
        icon="ability_druid_ferociousbite",
        body="#showtooltip Ferocious Bite\n/cast [stance:3] Ferocious Bite",
        tip="Burst direct damage finisher. Use when Rip is already active.",
    },
    {
        spec="Feral", name="Tiger's Fury",
        icon="ability_druid_tigersfury",
        body="#showtooltip Tiger's Fury\n/cast Tiger's Fury",
        tip="Instant +40 damage bonus for 6 sec. Also restores energy. Use on cooldown.",
    },
    {
        spec="Feral", name="Claw",
        icon="ability_druid_rake",
        body="#showtooltip Claw\n/cast [stance:3] Claw",
        tip="Basic Cat combo builder (no positional req). Use when Mangle on cooldown and cant Shred.",
    },
    {
        spec="Feral", name="Pounce",
        icon="ability_druid_bash",
        body="#showtooltip Pounce\n/cast [stance:3,stealth] Pounce",
        tip="Stealth-only stun opener (3 sec). Builds 1 CP + applies bleed.",
    },
    {
        spec="Feral", name="Ravage",
        icon="ability_druid_ravage",
        body="#showtooltip Ravage\n/cast [stance:3,stealth] Ravage",
        tip="Stealth high-damage opener from BEHIND target. Max opening burst.",
    },
    {
        spec="Feral", name="Faerie Fire (Feral)",
        icon="spell_nature_faeriefire",
        body="#showtooltip Faerie Fire (Feral)\n/cast [stance:3,5] Faerie Fire (Feral)",
        tip="Apply armor reduction in Cat or Bear form. Use to debuff boss.",
    },

    -- ── Feral Tank (Bear) ─────────────────────────────────────────────────────
    {
        spec="Feral", name="Dire Bear Form",
        icon="ability_racial_bearform",
        body="#showtooltip Dire Bear Form\n/cast [noform:5] Dire Bear Form\n/cast [form:5] Enrage",
        tip="Enter Dire Bear Form. If already bear, triggers Enrage for instant rage.",
    },
    {
        spec="Feral", name="Mangle (Bear)",
        icon="ability_druid_mangle2",
        body="#showtooltip Mangle (Bear)\n/cast [stance:1,5] Mangle (Bear)",
        tip="Highest threat + Mangle debuff in Bear form. Use on cooldown.",
    },
    {
        spec="Feral", name="Lacerate",
        icon="ability_druid_lacerate",
        body="#showtooltip Lacerate\n/cast [stance:1,5] Lacerate",
        tip="Bear bleed stack (5 stacks). Core single-target threat filler between Mangles.",
    },
    {
        spec="Feral", name="Maul",
        icon="ability_druid_maul",
        body="#showtooltip Maul\n/cast [stance:1,5] Maul",
        tip="Off-GCD bear melee hit on next attack. Use when rage > 50, similar to Heroic Strike.",
    },
    {
        spec="Feral", name="Swipe",
        icon="ability_druid_swipe",
        body="#showtooltip Swipe\n/cast [stance:1,5] Swipe",
        tip="AoE bear attack hitting all in front within 8 yards. Core AoE threat.",
    },
    {
        spec="Feral", name="Demoralizing Roar",
        icon="ability_druid_demoralizingroar",
        body="#showtooltip Demoralizing Roar\n/cast [stance:1,5] Demoralizing Roar",
        tip="-240 AP on all nearby enemies (like Demo Shout). Keep active on boss.",
    },
    {
        spec="Feral", name="Bash",
        icon="ability_druid_bash",
        body="#showtooltip Bash\n/cast [stance:1,5] Bash",
        tip="Bear 4-sec stun. Use to interrupt key casts in Bear form.",
    },
    {
        spec="Feral", name="Feral Charge (Bear)",
        icon="ability_hunter_pet_bear",
        body="#showtooltip Feral Charge (Bear)\n/cast [stance:1,5] Feral Charge (Bear)",
        tip="Gap closer + interrupt + immobilize in Bear form. Use on range gap or interrupt.",
    },
    {
        spec="Feral", name="Frenzied Regeneration",
        icon="ability_bullrush",
        body="#showtooltip Frenzied Regeneration\n/cast [stance:1,5] Frenzied Regeneration",
        tip="Bear emergency CD: converts rage to health. Use when below 30% HP.",
    },
    {
        spec="Feral", name="Enrage",
        icon="ability_druid_enrage",
        body="#showtooltip Enrage\n/cast [stance:1,5] Enrage",
        tip="Instant +20 rage but -27% armor for 10 sec. Use at pull or after low-rage windows.",
    },

    -- ── Utility ───────────────────────────────────────────────────────────────
    {
        spec="Feral", name="Innervate",
        icon="spell_nature_lightning",
        body="#showtooltip Innervate\n/cast [@mouseover,help,nodead][@player] Innervate",
        tip="Restore mana to mouseover healer or self. Huge utility CD — 6 min.",
    },
    {
        spec="Feral", name="Barkskin",
        icon="spell_nature_stoneclawtotem",
        body="#showtooltip Barkskin\n/cast Barkskin",
        tip="-20% damage reduction, ALL forms, usable while stunned. Emergency tanking CD.",
    },
    {
        spec="Feral", name="Nature's Grasp",
        icon="spell_nature_naturetouchgrow",
        body="#showtooltip Nature's Grasp\n/cast Nature's Grasp",
        tip="Next melee hit roots attacker. Use when being chased / kited.",
    },
    ...
    },
    {
        ...
        tip="Stack to 3 on tank and let bloom. Or roll 1-stack on multiple targets.",
    },
    {
        spec="Resto", name="Regrowth",
        icon="spell_nature_resistnature",
        body="#showtooltip Regrowth\n/cast [@mouseover,help,nodead][@target] Regrowth",
        tip="HoT + direct heal. Use for burst reactive healing supplementing Rejuv.",
    },
    {
        spec="Resto", name="Healing Touch",
        icon="spell_nature_healingtouch",
        body="#showtooltip Healing Touch\n/cast [@mouseover,help,nodead][@target] Healing Touch",
        tip="Large direct heal, long cast. Use with NS for instants or as spellhaste filler.",
    },
    {
        spec="Resto", name="Tranquility",
        icon="spell_nature_tranquility",
        body="#showtooltip Tranquility\n/cast Tranquility",
        tip="8-sec channeled AoE party heal. Emergency wipe-prevention CD.",
    },
    {
        spec="Resto", name="Swiftmend",
        icon="inv_relics_idolofrejuvenation",
        body="#showtooltip Swiftmend\n/cast [@mouseover,help,nodead][@target] Swiftmend",
        tip="Instant big heal consuming Rejuvenation or Regrowth HoT. TBC talent.",
    },
    {
        spec="Resto", name="NS + Healing Touch",
        icon="spell_nature_ravenform",
        body="#showtooltip Healing Touch\n/cast Nature's Swiftness\n/cast Healing Touch",
        tip="Instant maximum-rank Healing Touch. Strongest emergency heal combination.",
    },
    {
        spec="Resto", name="Innervate",
        icon="spell_nature_lightning",
        body="#showtooltip Innervate\n/cast [@mouseover,help,nodead][@player] Innervate",
        tip="Give raid healer free mana for 20 sec. Use on mouseover or self.",
    },
    {
        spec="Resto", name="Remove Curse",
        icon="spell_nature_removecurse",
        body="#showtooltip Remove Curse\n/cast [@mouseover,help,nodead][@target] Remove Curse",
        tip="Decurse mouseover or target. Druids are primary decursers in TBC.",
    },
    {
        spec="Resto", name="Abolish Poison",
        icon="spell_nature_nullifypoison_b",
        body="#showtooltip Abolish Poison\n/cast [@mouseover,help,nodead][@player] Abolish Poison",
        tip="Removes and prevents poison for 8 sec. Counter Rogues, Warlocks.",
    },
    ...
    -- ── PvP ──────────────────────────────────────────────────────────────────
    {
        ...
        tip="6-sec CC immune to all effects. Core druid PvP CC. Requires Balance talent.",
    },
    {
        spec="PvP", name="Entangling Roots",
        icon="spell_nature_stranglevines",
        body="#showtooltip Entangling Roots\n/cast [@mouseover,harm,nodead][@target] Entangling Roots",
        tip="Root target for up to 27 sec. Use to peel melee off healer.",
    },
    {
        spec="PvP", name="Nature's Grasp",
        icon="spell_nature_naturetouchgrow",
        body="#showtooltip Nature's Grasp\n/cast Nature's Grasp",
        tip="Next melee attacker gets rooted. Use as immediate peel.",
    },
    {
        spec="PvP", name="Bash (Bear PvP)",
        icon="ability_druid_bash",
        body="#showtooltip Bash\n/cast [stance:1,5] Bash",
        tip="Bear form 4-sec stun. Interrupt healer cast or stun for burst window.",
    },
    {
        spec="PvP", name="Pounce Opener",
        icon="ability_druid_bash",
        body="#showtooltip Pounce\n/cast [noform:3] Cat Form\n/cast [stance:3,nostealth] Prowl\n/cast [stance:3,stealth] Pounce",
        tip="Enter Cat, Prowl, then stun opener. 3-step stealth engage from one button.",
    },
    {
        spec="PvP", name="Faerie Fire (Feral)",
        icon="spell_nature_faeriefire",
        body="#showtooltip Faerie Fire (Feral)\n/cast [stance:3,5] Faerie Fire (Feral)",
        tip="Prevent stealth re-entry in cat/bear. Track vanished Rogues.",
    },
    {
        spec="PvP", name="Barkskin",
        icon="spell_nature_stoneclawtotem",
        body="#showtooltip Barkskin\n/cast Barkskin",
        tip="-20% damage, all forms, usable while stunned. Use immediately when CC'd.",
    },
    {
        spec="PvP", name="Travel Form",
        icon="ability_druid_travelform",
        body="#showtooltip Travel Form\n/cast Travel Form",
        tip="Instant 40% run speed. Best escape / roaming in open world PvP.",
    },
    {
        spec="PvP", name="Abolish Poison",
        icon="spell_nature_nullifypoison_b",
        body="#showtooltip Abolish Poison\n/cast [@player] Abolish Poison",
        tip="Remove + prevent poison on yourself every 3 sec for 8 sec. Counter Rogues.",
    },
    {
        spec="PvP", name="Remove Curse",
        icon="spell_nature_removecurse",
        body="#showtooltip Remove Curse\n/cast [@mouseover,help,nodead][@player] Remove Curse",
        tip="Decurse self or ally on mouseover. Removes powerful PvP curses.",
    },
}
