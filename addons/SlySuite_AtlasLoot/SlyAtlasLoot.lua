...
-- --------------------------------------------------------
-- Static TBC raid boss NPC ID â†’ name table
-- --------------------------------------------------------
local BOSS_NAMES = {
    -- Karazhan
    ...
    [23863] = "Zul'jin",
    -- Heroic Dungeons â€” final bosses
...
frame:SetScript("OnEvent", function(self, event, ...)
    if event == "ADDON_LOADED" then
        local name = ...
        if name == "SlySuite_AtlasLoot" then
            ...
            if SlySuiteDataFrame and SlySuiteDataFrame.Register then
                SlySuiteDataFrame.Register("SlyAtlasLoot", SAL.version, function()
