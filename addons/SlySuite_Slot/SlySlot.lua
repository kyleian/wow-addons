-- ============================================================
-- SlySlot.lua  â€”  Action bar profile manager
-- Save / load / export / import action bar layouts per character.
-- Replaces Myslot. /slyslot to toggle.
-- ============================================================

local ADDON_NAME = "SlySuite_Slot"
local ADDON_VERSION = "1.0.0"
local NUM_SLOTS     = 120    -- covers all 10 action bars (10 Ã— 12)
...
-- We escape ^ â†’ \1 and ; â†’ \2 in user-provided strings
-- -------------------------------------------------------
...
-- -------------------------------------------------------
-- FindOrCreateMacro(name, icon, body)  â†’  macroIndex
-- -------------------------------------------------------
local function FindOrCreateMacro(name, icon, body)
    ...
    -- Not found â€” create it (global macro)
...
-- -------------------------------------------------------
-- SlySlot_ExportProfile(name)  â†’  exportString
...
-- -------------------------------------------------------
-- SlySlot_ImportProfile(exportString)  â†’  profileName
    ...
    if event == "ADDON_LOADED" and arg1 == ADDON_NAME then
        ...
        if SlySuiteDataFrame and SlySuiteDataFrame.Register then
            SlySuiteDataFrame.Register(ADDON_NAME, ADDON_VERSION, function() end, {
                description = "Action bar profile manager â€” save/load/export/import.",
                slash       = "/slyslot",
...
SlashCmdList["SLYSLOT"] = function(msg)
    ...
    elseif msg == "help" then
        ...
        print("  |cffffcc00/slyslot|r              â€” toggle UI")
        print("  |cffffcc00/slyslot save <name>|r  â€” save current bars")
        print("  |cffffcc00/slyslot load <name>|r  â€” load a profile")
        print("  |cffffcc00/slyslot list|r          â€” list all profiles")
    end
end
