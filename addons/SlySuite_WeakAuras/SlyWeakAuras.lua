-- ============================================================
-- Sly WeakAuras â€” SlyWeakAuras.lua
...
local ADDON_NAME = "SlySuite_WeakAuras"
...
SlashCmdList["SLYWEAKAURAS"] = function(msg)
    ...
    elseif msg == "status" then
        if SlyWA_IsWeakAurasLoaded() then
            print("|cff00ccff[SlyWeakAuras]|r WeakAuras |cff44ff44ACTIVE|r â€” "
                .. SlyWA_GetWAVersion())
        else
    ...
    elseif msg == "help" then
        ...
        print("  |cffffcc00/slywa|r           â€” toggle the pack manager")
        print("  |cffffcc00/slywa status|r    â€” WeakAuras connection + pack count")
        print("  |cffffcc00/slywa packs|r     â€” list all stored packs")
        print("  |cffffcc00/slywa help|r       â€” this text")
    end
end
