...
function SC_BuildMain()
    ...
    local setsScroll = CreateFrame("ScrollFrame", nil, setsTab, "UIPanelScrollFrameTemplate")
    setsScroll:SetPoint("TOPLEFT",     setsTab, "TOPLEFT",     PAD, -48)
    setsScroll:SetPoint("BOTTOMRIGHT", setsTab, "BOTTOMRIGHT", -22,   2)
    local setsCont = CreateFrame("Frame", nil, setsScroll)
    setsCont:SetSize(SIDE_W - PAD*2 - 22, MAX_SET_ROWS * 22)
